...
backup-drupal-default:
	cd ./volumes/obibadocker_drupal_sites_default/_data/ && \
	tar -cvf $(BACKUP_FOLDER)/drupal_default.tar *

backup-drupal-libraries:
	cd ./volumes/obibadocker_drupal_sites_libraries/_data/ && \
	tar -cvf $(BACKUP_FOLDER)/drupal_libraries.tar *

backup-drupal-modules:
	cd ./volumes/obibadocker_drupal_sites_modules/_data/ && \
	tar -cvf $(BACKUP_FOLDER)/drupal_modules.tar *

backup-drupal-themes:
	cd ./volumes/obibadocker_drupal_sites_themes/_data/ && \
	tar -cvf $(BACKUP_FOLDER)/drupal_themes.tar *

backup-drupal-vendor:
	cd ./volumes/obibadocker_drupal_sites_vendor/_data/ && \
...
restore-drupal-default:
	cp $(BACKUP_FOLDER)/drupal_default.tar ./volumes/obibadocker_drupal_sites_default/_data/ && \
    cd ./volumes/obibadocker_drupal_sites_default/_data/ && \
    tar -xvf drupal_default.tar

restore-drupal-libraries:
	cp $(BACKUP_FOLDER)/drupal_libraries.tar ./volumes/obibadocker_drupal_sites_libraries/_data/ && \
    cd ./volumes/obibadocker_drupal_sites_libraries/_data/ && \
    tar -xvf drupal_libraries.tar

restore-drupal-modules:
	cp $(BACKUP_FOLDER)/drupal_modules.tar ./volumes/obibadocker_drupal_sites_modules/_data/ && \
    cd ./volumes/obibadocker_drupal_sites_modules/_data/ && \
    tar -xvf drupal_modules.tar

restore-drupal-themes:
	cp $(BACKUP_FOLDER)/drupal_themes.tar ./volumes/obibadocker_drupal_sites_themes/_data/ && \
    cd ./volumes/obibadocker_drupal_sites_themes/_data/ && \
    tar -xvf drupal_themes.tar

restore-drupal-vendor:
	cp $(BACKUP_FOLDER)/drupal_vendor.tar ./volumes/obibadocker_drupal_sites_vendor/_data/ && \
    cd ./volumes/obibadocker_drupal_sites_vendor/_data/ && \
